...
import useCheckCollection from '../../hooks/useCheckCollection';
...
export default function MovieDetails() {
	...
	const checkMovie = useCheckCollection({ movieId: id });
	...
	return (
		<div className='flex flex-row text-center z-50 bg-amber-200/10 m-5 rounded-xl shadow-2xl '>
			...
			<div className='flex flex-col gap-5 text-center z-50'>
				...
				>
					<h2 className='m-1 mt-5 font-bold'>Director: {movie.director}</h2>
