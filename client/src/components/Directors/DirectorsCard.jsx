export default function DirectorsCard({ name, imageUrl, country }) {
	return (
		<>
			<div
				key={name}
				className=' flex flex-col justify-around transition-all duration-300 ease-in-out hover:border-amber-400 hover:bg-amber-200/20 hover:shadow-amber-300/70 min-w-40 bg-black/70 m-5 text-center rounded-xl sm:py-1 shadow-amber-300/40 shadow-lg border-amber-200 border border-solid'
			>
