...
export default function MyWacthlistCard() {
	...
	return (
		<div className='backdrop-blur max-w-200  transition-all duration-300 ease-in-out hover:border-amber-00 hover:bg-black/50 hover:shadow-amber-300/70 min-w-60 bg-black/70 m-5 text-center rounded-xl sm:py-1 shadow-amber-300/50 shadow-2xl border-amber-200/80 border-2 border-solid'>
